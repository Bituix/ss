CLASS zcx_ca_status_error DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      ...
      "& Target status is ambiguous — multiple active actions qualify, supply iv_to_status_code
    ...
    DATA:
      status_type_id      TYPE zcastat_e_typeid READ-ONLY,
      business_obj_key    TYPE zcastat_e_bokey  READ-ONLY,
      from_status         TYPE zcastat_e_code   READ-ONLY,
      to_status           TYPE zcastat_e_code   READ-ONLY,
      action_code         TYPE char20           READ-ONLY,
    ...
    METHODS constructor
      IMPORTING
        ...
        status_type_id   TYPE zcastat_e_typeid          OPTIONAL
        business_obj_key TYPE zcastat_e_bokey           OPTIONAL
        from_status      TYPE zcastat_e_code            OPTIONAL
        to_status        TYPE zcastat_e_code            OPTIONAL
        action_code      TYPE char20                    OPTIONAL
  ...
  METHOD constructor.
    CALL METHOD super->constructor
      EXPORTING
        textid   = textid
        previous = previous.
    me->status_type_id   = status_type_id.
    me->business_obj_key = business_obj_key.
