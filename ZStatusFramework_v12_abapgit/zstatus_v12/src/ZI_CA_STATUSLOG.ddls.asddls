...
@EndUserText.label: 'Z-Status Framework: Status Log Interface View (Read-Only)'
    ...
    and $projection.ToStatus    = _ToStatus.StatusCode
{
  key log.log_uuid     as LogUuid,
      ...
      _ToStatus.StatusLabel      as ToStatusLabel,
      _FromStatus.StatusLabel    as FromStatusLabel,
